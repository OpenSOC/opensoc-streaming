...
*/
public class ISEParser implements ISEParserConstants {
  ...
  /**
	...
	*/
  public LinkedHashMap < String, String > parseObject() throws ParseException
  {
    LinkedHashMap < String, String > toReturn = object();
  ...
  final public LinkedHashMap < String, String > object() throws ParseException {
  final LinkedHashMap < String, String > map = new LinkedHashMap < String, String > ();
  String key;
  String value;
    key = objectKey();
