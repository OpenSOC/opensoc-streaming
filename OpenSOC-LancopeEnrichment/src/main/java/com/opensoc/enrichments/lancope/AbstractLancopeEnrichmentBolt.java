...
public abstract class AbstractLancopeEnrichmentBolt extends BaseRichBolt {
	/**
	 * 
	 */
	...
	protected static final Logger LOG = LoggerFactory
			.getLogger(AbstractLancopeEnrichmentBolt.class);

	protected OutputCollector _collector;
	protected String _OutputFieldName;
	protected AbstractLancopeAdapter _adapter;
